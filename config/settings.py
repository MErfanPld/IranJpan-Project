...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.redirect_to',
                'core.context_processors.language_alternates',
            ],
        },
    },
]
...
MODELTRANSLATION_LANGUAGES = ('fa', 'en', 'ja')
...
# Always useful (safe in development too)
